...
- id: "capsule_discovery"
  ...
  title: "Martian Capsule Found"
  description: "Proto-life and encrypted data capsule discovered during excavation"
  causes: ["mars_colony_establishment"]
  effects: ["proto_life_analysis", "foundation_awareness"]
  visibility: "restricted"
  status: "confirmed"
  tags: ["simulation", "consciousness", "mars", "discovery"]

- id: "proto_life_analysis"
  date: "2030-2032"
  scale: "macro"
  category: "discovery"
  location: "project_521"
  actors: ["project_521_team"]
  event_type: "discovery"
  title: "Proto-Life Analysis Phase"
  description: "Initial biological analysis reveals intentional seeding patterns"
  causes: ["capsule_discovery"]
  effects: ["pattern_recognition"]
  visibility: "restricted"
  status: "confirmed"
  tags: ["biology", "analysis", "intentional_seeding"]
...
- id: "foundation_awareness"
  ...
  event_type: "discovery"
  title: "Foundation Learns of Discovery"
  description: "Foundation becomes aware of Project 521 findings through surveillance"
  causes: ["capsule_discovery"]
...
- id: "pattern_recognition"
  ...
  actors: ["project_521_team"]
  event_type: "discovery"
  title: "Intentional Seeding Recognition"
  description: "Team recognizes proto-life was deliberately sent to solar system"
  causes: ["proto_life_analysis"]
  effects: ["quantum_consciousness_research", "infiltration_execution"]
  visibility: "restricted"
  status: "confirmed"
  tags: ["intentional_seeding", "alien_contact", "great_filter"]
...
- id: "infiltration_execution"
  ...
  causes: ["infiltration_planning", "pattern_recognition"]
...
- id: "quantum_consciousness_research"
  ...
  event_type: "discovery"
  title: "Consciousness-Reality Connection Research"
  description: "Team discovers quantum connections between consciousness and reality manipulation"
  causes: ["pattern_recognition", "infiltration_execution"]
...
- id: "simulation_hypothesis"
  ...
  description: "Overwhelming evidence suggests universe is simulation, consciousness can break it"
  causes: ["quantum_consciousness_research"]
  effects: ["great_filter_understanding", "foundation_crisis_response"]
  visibility: "restricted"
  status: "confirmed"
  tags: ["simulation", "consciousness", "great_filter", "reality"]
...
- id: "foundation_crisis_response"
  ...
  description: "Aya accelerates takeover plans due to simulation discovery threat"
  causes: ["simulation_hypothesis", "intelligence_flow"]
